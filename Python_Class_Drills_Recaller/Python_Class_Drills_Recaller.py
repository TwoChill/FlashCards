...
# Dictionary with questions on the LEFT and the answers to the Right.
dic_quiz = {
...
def rapport_1dgt():
    print(f'''
      ...
      ==================================
     |       Correct Answered:    {correct_answered}    |
     |       Incorrect Answered:  {incorrect_answered}    |
     |       Total Questions:    {total_answered}     |
     |                                  |
     |       Your Grade:         {grade}      |
      ==================================
    ''')
...
def quit(grade):
    if grade == 10 or total_answered >= 10 or incorrect_answered >= 10 or correct_answered >= 10:
        try:
            grade = int(correct_answered * 10 / total_answered)
...
correct_answered = 0
total_answered = 0
incorrect_answered = total_answered - correct_answered
grade = 0
...
# This block is to prompt user to choose a category.
try:
    ranges = int(input(('''
    ...
    # with the corresponding dictionary ranges.
    if ranges == 1:
        print("\n\t:> All Questions")
